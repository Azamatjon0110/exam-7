	...
	return (
		...
		>
			...
			<Box sx={{ display: 'flex', paddingTop: '14px', marginBottom: '100px' }}>
				...
				<Box sx={{ width: '57%', marginTop: '44px' }}>
					...
					>
						<TextName variant={theme}>
							{Language[lang].singlePage.page}
						</TextName>
						<TextValue variant={theme}>
							{data.page + Language[lang].singlePage.pagetext}
						</TextValue>
					</Box>
					<Box
						sx={{
					...
					>
						<TextName variant={theme}>
							{Language[lang].singlePage.year}
						</TextName>
						<TextValue variant={theme}>
							{data.year + Language[lang].singlePage.yearText}
						</TextValue>
					</Box>
					<Box
						sx={{
					...
					>
						<TextName variant={theme}>
							{Language[lang].singlePage.price}
						</TextName>
						<TextValue variant={theme}>${data.price}</TextValue>
					</Box>
					<Box
						sx={{
							display: 'flex',
					...
					>
						<Box sx={{ width: '100%', maxWidth: '155px' }}>
							<Info>{Language[lang].singlePage.info}</Info>
						</Box>
						<Line></Line>
					</Box>
					<Text variant={theme}>{data.description}</Text>
				</Box>
			</Box>
			<Box>
				<Box
				...
				{!books.length === 0 ? (
					...
					<Text variant={theme}>No books...</Text>
				)}
			</Box>
		</Box>
	);
